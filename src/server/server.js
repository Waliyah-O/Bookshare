...
createServer({
  ...
  seeds(server) {
    server.create("book", {
      ...
      price: 0,
      description:
        "Principles of Physics is a fundamental textbook designed to provide a comprehensive and engaging introduction to the core principles of physics. Authored by experts in the field, this free textbook seamlessly integrates theoretical concepts with real-world applications, making it an indispensable resource for students and educators alike",
    ...
    server.create("book", {
      ...
      price: 3160,
      description:
        "Unlock the secrets of the English language with 'Essentials of English Grammar.' This comprehensive textbook is your key to mastering the fundamental rules and structures that form the backbone of effective communication in English.",
